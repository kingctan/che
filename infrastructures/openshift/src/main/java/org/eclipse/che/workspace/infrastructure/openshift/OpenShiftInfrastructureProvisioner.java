...
import org.eclipse.che.workspace.infrastructure.openshift.provision.PrefixedNameProvisioner;
...
public class OpenShiftInfrastructureProvisioner {
  ...
  private final PrefixedNameProvisioner prefixNameProvisioner;
  ...
  public OpenShiftInfrastructureProvisioner(
      ...
      PrefixedNameProvisioner prefixNameProvisioner) {
